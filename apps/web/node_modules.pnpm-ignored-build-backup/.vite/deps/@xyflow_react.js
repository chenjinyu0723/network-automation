...
import {
  require_jsx_runtime
} from "./chunk-KCRDKY6U.js";
import {
  require_react_dom
} from "./chunk-GXHL7DSH.js";
import {
  require_react
} from "./chunk-O7XGUD2N.js";
import {
  __commonJS,
  __toESM
} from "./chunk-OO6A2D4V.js";
...
// node_modules/.pnpm/@xyflow+react@12.11.2_@type_c5cc53086d2b56e30015f70465c372b8/node_modules/@xyflow/react/dist/esm/index.js
...
// node_modules/.pnpm/@xyflow+system@0.0.79/node_modules/@xyflow/system/dist/esm/index.js
var errorMessages = {
...
// node_modules/.pnpm/zustand@4.4.0_@types+react@18.3.31_react@18.3.1/node_modules/zustand/esm/traditional.mjs
var import_react = __toESM(require_react(), 1);
var import_with_selector = __toESM(require_with_selector(), 1);

// node_modules/.pnpm/zustand@4.4.0_@types+react@18.3.31_react@18.3.1/node_modules/zustand/esm/vanilla.mjs
...
// node_modules/.pnpm/zustand@4.4.0_@types+react@18.3.31_react@18.3.1/node_modules/zustand/esm/shallow.mjs
...
function Pane({ isSelecting, selectionKeyPressed, selectionMode = SelectionMode.Full, panOnDrag, autoPanOnSelection, paneClickDistance, selectionOnDrag, onSelectionStart, onSelectionEnd, onPaneClick, onPaneContextMenu, onPaneScroll, onPaneMouseEnter, onPaneMouseMove, onPaneMouseLeave, children: children2 }) {
  ...
  const store = useStoreApi();
  const { userSelectionActive, elementsSelectable, dragging, panBy: panBy2, autoPanSpeed } = useStore(selector$g, shallow);
...
function useVisibleNodeIds(onlyRenderVisible) {
  const nodeIds = useStore((0, import_react2.useCallback)(selector$c(onlyRenderVisible), [onlyRenderVisible]), shallow);
  return nodeIds;
}
...
function useInternalNode(id2) {
  const node = useStore((0, import_react2.useCallback)((s) => s.nodeLookup.get(id2), [id2]), shallow);
  return node;
}
...
function BackgroundComponent({
  ...
  const { transform: transform2, patternId } = useStore(selector$3, shallow);
...
function ResizeControl({ nodeId, position, variant = ResizeControlVariant.Handle, className, style: style2 = void 0, children: children2, color: color2, minWidth = 10, minHeight = 10, maxWidth = Number.MAX_VALUE, maxHeight = Number.MAX_VALUE, keepAspectRatio = false, resizeDirection, autoScale = true, shouldResize, onResizeStart, onResize, onResizeEnd }) {
  ...
  const scale = useStore((0, import_react2.useCallback)(scaleSelector(isHandleControl && autoScale), [isHandleControl, autoScale]), shallow);
